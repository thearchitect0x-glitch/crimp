...
| **Per-program config** — clocks, restoration windows, appeal-rights text | 3 · 4 · 5 | Clocks landed in cap-03 (`clocks.config.ts`, seven federal defaults, each `TODO(legal-confirm)`); restoration and appeal text with caps 4 and 5 |
