...
| Gap | Needed by | Shape |
|---|---|---|
| **Rule registry** — id, version, citation, effective dates, as-of selection | 1(d) · 6 · 7 · 8 · 10 | Additive `rule_ref` on seals; a `rulesets` / `rules` table; the inline rule stays |
